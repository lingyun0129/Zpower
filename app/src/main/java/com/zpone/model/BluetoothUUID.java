...
public interface BluetoothUUID {
    ...
    //Ring
    //Service
    UUID M306_SERVICE=UUID.fromString("000068a0-0000-1000-8000-00805F9B34FB");
    //characteristics
    UUID M306_WRITE_CHAR=UUID.fromString("000068a1-0000-1000-8000-00805F9B34FB");
    UUID M306_NOTIFY_CHAR=UUID.fromString("000068a2-0000-1000-8000-00805F9B34FB");
}
