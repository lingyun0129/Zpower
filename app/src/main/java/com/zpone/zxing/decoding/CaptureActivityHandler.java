...
import com.zpone.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
	...
	private final com.zpone.zxing.decoding.DecodeHandlerInterface handlerInterface;
	...
	public CaptureActivityHandler(com.zpone.zxing.decoding.DecodeHandlerInterface handlerInterface,
	...
	public void handleMessage(Message message) {
		...
		case R.id.return_scan_result:
			...
			handlerInterface.resturnScanResult(
					com.zpone.zxing.decoding.DecodeHandlerInterface.RESULT_STATE_OK, (Intent) message.obj);
			break;
