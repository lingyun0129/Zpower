...
import com.zpower.zxing.camera.CameraManager;
import com.zpower.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
	...
	private final com.zpower.zxing.decoding.DecodeHandlerInterface handlerInterface;
	...
	public CaptureActivityHandler(com.zpower.zxing.decoding.DecodeHandlerInterface handlerInterface,
	...
	public void handleMessage(Message message) {
		...
		case R.id.return_scan_result:
			...
			handlerInterface.resturnScanResult(
					com.zpower.zxing.decoding.DecodeHandlerInterface.RESULT_STATE_OK, (Intent) message.obj);
			break;
